...
export function SectionHero() {
    ...
    const thumbs = files.map(file => (
        <div className="inline-flex rounded-lg mt-4  box-border justify-center m-auto" key={file.name}>
        ...
        <section className="pt-10">
            <ContainerGrid className='flex flex-col'>
                ...
                <div>
                    ...
                    <div {...getRootProps()}
                        className={`m-auto flex items-center justify-center border-dashed border-2 cursor-pointer border-gray-600 rounded-xl transition-text easy-in-out duration-500 p-5 h-52 max-w-xl
